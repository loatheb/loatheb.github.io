---
title: immer.js 简介及源码简析：更简单，更快速的创建不可变数据类型
date: '2018-2-1'
---
...
真正翻开源码，诚然里面确实有 defineProperty 的身影，不过在另一个核心的文件中，用了一种新的方式，那就是 ES6 中新增的 Proxy 对象。Proxy 对象允许拦截某些操作并实现自定义行为，但大多数 JS 程序员可能并不经常使用这种元编程模式，所以这里简单且快速的介绍一下它的使用。
